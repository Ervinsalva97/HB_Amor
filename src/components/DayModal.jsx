...
const dayContents = {
    ...
    6: { type: 'image', title: "Día 6", text: "La noche siempre será mi momento favorito, pero desde que estás tú, hasta el día es más bonito." },
    7: { type: 'list', title: "Día 7", text: "Cosas que hacen que mi mundo gire mejor:", list: ["Escucharte hablar de tus metas y de como te fué el día", "Ver tus stickers de monito con un corazón", "Verte feliz y que me digas, Enserio? no me estás mintiendo? waaa, gachaaas", "Nuestras bromas con mi 'cuñada' Nayu (y era a la que quería que sea nuestra alcahueta)", "Saber que eres mi novia (la más bella, princesa inalcanzable que todos desean)"] },
    8: { type: 'text', title: "Día 8: Día de la Mujer", text: "Feliz día a la mujer que se esfuerza por ser mejor ella misma, superando sus miedos y traumas estando sola, mejorando cada día por verse mejor. Lo tienes todo Arianita hermosa, no dejes que nadie te diga lo contrario. 🤍" },
    ...
    12: { type: 'text', title: "Día 12", text: "Espero que los regalitos te estén gustando amor. \nSi el dinero que tengo fuera ilimitado, \nte compraría el mundo entero; \nmas como solo quiero lo que tenemos en privado, \nno hace falta ser millonario." },
